...
export const STRINGS = {
  ...
  MANIFEST_IS_MISSING: 'Manifest is missing.', // TODO remove?
...
`,
  ...
  CLI_MESSAGES: {
    ...
    add: 'Add plugin packages to the impact engine. E.g. `impact-engine add @grnsft/if-models`',
    list: 'List all added plugins.',
    remove:
      'Remove plugin packages to the impact engine. E.g. `impact-engine remove @grnsft/if-models`',
  },
};
