...
const REGISTRY_CONTRACT_ADDRESS: string = process.env.REGISTRY_CONTRACT_ADDRESS ?? '';
const RESOLVER_CONTRACT_ADDRESS: string = process.env.RESOLVER_CONTRACT_ADDRESS ?? '';
