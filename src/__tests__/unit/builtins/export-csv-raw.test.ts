  ...
  describe('ExportCSVRaw: ', () => {
    ...
    describe('init GroupBy: ', () => {
      it('initalizes object with properties.', async () => {
        expect(exportCSVRaw).toHaveProperty('executeExhaust');
      });
    });
    ...
    describe('execute(): ', () => {
      it('generates CSV file with correct data.', async () => {
        ...
        await exportCSVRaw.executeExhaust(tree, context, outputPath);
      ...
      it('throws an error when the CSV file could not be created.', async () => {
        ...
        await expect(
          exportCSVRaw.executeExhaust(tree, context, outputPath)
        ).rejects.toThrow(
          new WriteFileError(
